...
class LabelDataFieldName(str, Enum):
    """Valid field names for LabelDataMeta."""
...
class LabelDataMeta(Base, table=True):
    """Metadata for LabelData fields (review flags, notes, AI generation tracking)."""

    __table_args__ = (
        UniqueConstraint(
            "label_id", "field_name", name="uq_labeldatameta_label_id_field_name"
        ),
    )
