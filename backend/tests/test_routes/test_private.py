...
async def test_create_user_no_verification(
    client: TestClient, db: AsyncSession
) -> None:
    """Test creating user without email verification."""
    email = random_email()
...
async def test_create_user_no_verification_minimal_data(client: TestClient) -> None:
...
async def test_create_user_no_verification_duplicate_email(client: TestClient) -> None:
...
async def test_create_user_no_verification_invalid_email(client: TestClient) -> None:
...
async def test_create_user_no_verification_missing_password(client: TestClient) -> None:
...
async def test_create_user_no_verification_missing_email(client: TestClient) -> None:
