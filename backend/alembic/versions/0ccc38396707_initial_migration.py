...
Revision ID: 0ccc38396707
Revises:
Create Date: 2026-03-14 00:47:11.086370
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_legislation_product_type_id'), 'legislation', ['product_type_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_legislation_product_type_id'), table_name='legislation')
